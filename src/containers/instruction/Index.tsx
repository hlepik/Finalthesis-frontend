...
import { Grid, Pagination, styled, TablePagination, Typography } from "@mui/material";
...
const InstructionIndex = () => {
    ...
    const deleteInstruction = async () => {
        let result = await BaseService.delete<IInstruction>("/Instructions/" + deleteId, appState.token!);
        if (result.ok && result.data) {
            handleClose();
            setAlertMessage({
        ...
        <>
            <Grid container className={"layoutContainer"}>
                ...
                <Grid className={"DataTableGrid"} flexDirection={"column"}>
                    ...
                    <Grid className={"AddButton"}>
                        <BasicButton btnType={"black"} label={"Lisa uus"} onClick={handleNavigation} />
                    </Grid>
                </Grid>
                <TableGrid>
                    <DataGrid
            ...
            <DialogScreen handleClose={handleClose} isOpened={modalState}>
                ...
                <Grid className={"formButton"}>
                    <BasicButton btnType={"red"} label={"Kustuta"} onClick={deleteInstruction} />
                </Grid>
            </DialogScreen>
        </>
    );
